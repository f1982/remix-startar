...
import type { KeyProps } from "~/components/keyboard/SimpleKeyboard";
import Keyboard from "~/components/keyboard/SimpleKeyboard";

import { useOptionalUser } from "~/utils";
const keyboardMockData: KeyProps[] =  require('../components/keyboard/mock-data.json')

export default function Index() {
  const user = useOptionalUser();
  return (
    <div>
      <Keyboard config={keyboardMockData} />
